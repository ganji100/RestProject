...
public class ClassicalMedicinesRequest {
	 ...
	 * 
	 * @JoinColumn( name="fk_cmId",referencedColumnName = "cmId") private
	 * List<ClassicalMedicinesProducts> products;
	 * 
	 */
	public ClassicalMedicinesRequest(){
		super();
	}


	public ClassicalMedicinesRequest(int cmclassicalMedicineIdId, String classicalMedicineName, String createdBy, String updatedBy, Date createdDate,
			Date updatedDate) {
		super();
	...
	/*
	 * public List<ClassicalMedicinesProducts> getProducts() { return products; }
	 * 
	 * 
